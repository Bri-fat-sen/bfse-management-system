      ...
      <Dialog>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Show Attendance Data</Label>
                <p className="text-xs text-gray-500">Display days/hours worked section</p>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">Display tax bracket information</p>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">Display payment bank information</p>
              </div>
              <Switch 
                checked={options.showBankDetails} 
                onCheckedChange={(v) => setOptions({...options, showBankDetails: v})} 
              />
            </div>
            
            <div className="flex items-center justify-between">
              <div>
                <Label>Show Employer Cost</Label>
                <p className="text-xs text-gray-500">Include employer NASSIT contribution</p>
              </div>
              <Switch 
            ...
            <div className="space-y-2">
              ...
              <Select value={options.colorScheme} onValueChange={(v) => setOptions({...options, colorScheme: v})}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="green">
                    <span className="flex items-center gap-2">
                      <span className="w-3 h-3 rounded-full bg-[#1EB053]"></span>
                      Green (Sierra Leone)
                    </span>
                  </SelectItem>
                  <SelectItem value="blue">
                    <span className="flex items-center gap-2">
                      <span className="w-3 h-3 rounded-full bg-[#0072C6]"></span>
                      Blue (Corporate)
                    </span>
                  </SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Select value={options.layout} onValueChange={(v) => setOptions({...options, layout: v})}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="modern">Modern (Dark Header)</SelectItem>
                  <SelectItem value="classic">Classic (Light Header)</SelectItem>
