...
// 1 NLE = 1000 old SLE (redenomination April 2024)
// Note: Varies by sector - these are general private sector minimums
export const SL_MINIMUM_WAGE = {
  monthly: 800,     // NLE 800 per month (general private sector)
  daily: 36,        // Approximately NLE 36 per day
  hourly: 5,        // Approximately NLE 5 per hour
  // Sector-specific minimums (common practices)
  sectors: {
    domestic: 500,        // Domestic workers (lower threshold)
    agriculture: 600,     // Agricultural workers
    mining: 1200,         // Mining sector (higher due to risk)
    construction: 900,    // Construction workers
    security: 700,        // Security guards
    hospitality: 650      // Hotels/restaurants
  }
};

// Working Hours - Per Employment Act 2023 Section 36
export const SL_WORKING_HOURS = {
  standardDaily: 8,           // 8 hours per day
  standardWeekly: 40,         // 40 hours per week (5 days)
  maxDailyWithOvertime: 12,   // Maximum 12 hours including overtime
  maxWeeklyWithOvertime: 60,  // Maximum 60 hours per week
  lunchBreak: 1,              // Minimum 1 hour lunch break for 8+ hour shifts
  restDayPerWeek: 1,          // Minimum 1 rest day per week
  nightShiftStart: "20:00",   // Night shift begins 8:00 PM
  nightShiftEnd: "06:00"      // Night shift ends 6:00 AM
};
