...
export default function BatchStockAllocation({
  ...
  const allocateMutation = useMutation({
    mutationFn: async () => {
      ...
      // Log audit trail for stock allocation
      const allocationDetails = allocationsToProcess.map(a => ({
      ...
      await logInventoryAudit({
        ...
        notes: `Allocated ${totalAllocated} units from batch ${batch.batch_number} to ${allocationsToProcess.length} location(s)`,
        details: { allocations: allocationDetails },
