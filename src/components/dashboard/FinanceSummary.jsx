      ...
      <CardContent>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="p-2 bg-green-50 rounded-lg text-center">
            ...
            <p className="text-sm font-bold text-green-700">Le {(totalRevenue / 1000).toFixed(0)}K</p>
          </div>
          <div className="p-2 bg-red-50 rounded-lg text-center">
            ...
            <p className="text-sm font-bold text-red-700">Le {(totalExpenses / 1000).toFixed(0)}K</p>
          </div>
