...
<div class="sl-document">
  ...
  <div class="sl-section">
    ...
    <p>Where required by the nature of work:</p>
    <ul>
      <li>The Company will provide appropriate PPE at no cost to employees</li>
      <li>Employees must use PPE correctly and consistently</li>
      <li>Report damaged or worn PPE immediately for replacement</li>
      <li>Never modify or bypass safety equipment</li>
      <li>PPE includes but is not limited to: safety boots, hard hats, gloves, eye protection, high-visibility clothing, and hearing protection</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>6. FIRST AID</h2>
    <p>First aid provisions are in place to ensure immediate response to injuries:</p>
    <ul>
      <li><strong>First Aid Kits:</strong> Located at {{first_aid_locations}}</li>
      <li><strong>Trained First Aiders:</strong> Available during all working hours. A list of first aiders is posted on notice boards</li>
      <li><strong>In Case of Injury:</strong> Seek first aid immediately. Do not attempt to self-treat serious injuries</li>
      <li><strong>Medical Emergencies:</strong> Call emergency services (022 for Ambulance) and the designated first aider simultaneously</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>7. ACCIDENT & INCIDENT REPORTING</h2>
    <p>Prompt reporting is essential for prevention and legal compliance:</p>
    <ul>
      <li><strong>All Accidents:</strong> Must be reported to your supervisor immediately, regardless of severity</li>
      <li><strong>Accident Book:</strong> All incidents must be recorded in the official accident book with full details</li>
      <li><strong>Near Misses:</strong> Report near-miss incidents to help prevent future accidents</li>
      <li><strong>Investigation:</strong> All reported incidents will be investigated to identify causes and prevent recurrence</li>
      <li><strong>Serious Accidents:</strong> Will be reported to the Ministry of Labour and relevant authorities as required by law</li>
      <li><strong>Occupational Diseases:</strong> Report any work-related health conditions to HR and your supervisor</li>
    </ul>
  </div>
  ...
  <div class="sl-section">
    <h2>8. FIRE SAFETY</h2>
    <ul>
      <li>Know the location of fire exits, fire extinguishers, and assembly points</li>
      <li>Keep fire exits and escape routes clear at all times</li>
      <li>Participate in fire drills and take them seriously</li>
      <li>If you discover a fire: Raise the alarm, evacuate, and call emergency services (020 for Fire)</li>
      <li>Only attempt to fight small fires if trained and safe to do so</li>
      <li>Never return to a building until the all-clear is given</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>9. WORKPLACE HAZARDS</h2>
    <p>Common workplace hazards and prevention measures:</p>
    <ul>
      <li><strong>Slips, Trips & Falls:</strong> Keep walkways clear, clean up spills immediately, report uneven surfaces</li>
      <li><strong>Manual Handling:</strong> Use proper lifting techniques, ask for help with heavy loads, use equipment when available</li>
      <li><strong>Electrical Safety:</strong> Report damaged cables or equipment, don't overload sockets, never use damaged electrical items</li>
      <li><strong>Hazardous Substances:</strong> Follow safety data sheets, use appropriate PPE, store chemicals correctly</li>
      <li><strong>Display Screen Equipment:</strong> Take regular breaks, adjust workstation ergonomically, report discomfort</li>
    </ul>
  </div>
  ...
  <div class="sl-section">
    ...
    <ul>
      ...
      <li>Report any medical conditions that may affect your work or safety</li>
      <li>Take regular breaks to prevent fatigue</li>
      <li>Stay hydrated, especially in hot conditions</li>
      <li>Report stress or mental health concerns to your manager or HR</li>
      <li>Do not work while under the influence of alcohol or drugs</li>
    </ul>
  </div>
...
<div class="sl-document">
  ...
  <div class="sl-section">
    <h2>5. Duration & Survival</h2>
    <div class="sl-highlight-box">
      <h3>⏱️ Agreement Duration</h3>
      <p>This Agreement shall remain in full force and effect during the Employee's employment with the Company and for a period of <strong>{{duration_years}} years</strong> following the termination of employment for any reason whatsoever, whether voluntary or involuntary.</p>
      <p>Certain obligations, particularly those relating to trade secrets and information that remains confidential, shall survive indefinitely.</p>
    </div>
  </div>
  ...
  <div class="sl-section">
    ...
    <p>The Employee acknowledges and agrees that:</p>
    <ul>
      <li>All inventions, discoveries, improvements, designs, works, and creations made by the Employee during employment that relate to the Company's business or result from use of Company resources shall be the sole and exclusive property of the Company</li>
      <li>The Employee hereby assigns all rights, title, and interest in such intellectual property to the Company</li>
      <li>The Employee shall execute any documents necessary to perfect the Company's ownership rights</li>
    </ul>
  </div>
  ...
  <div class="sl-section">
    ...
    <p>The Employee acknowledges and agrees that:</p>
    <ul>
      <li><strong>Irreparable Harm:</strong> Any breach or threatened breach of this Agreement may cause irreparable harm to the Company for which monetary damages alone would be inadequate</li>
      <li><strong>Injunctive Relief:</strong> The Company shall be entitled to seek immediate injunctive or other equitable relief to prevent or restrain any breach without the need to prove actual damages or post a bond</li>
      <li><strong>Monetary Damages:</strong> In addition to equitable relief, the Company may recover all actual damages, including lost profits, caused by the breach</li>
      <li><strong>Legal Costs:</strong> The breaching party shall be responsible for all legal fees, court costs, and expenses incurred in enforcing this Agreement</li>
      <li><strong>Cumulative Remedies:</strong> All remedies are cumulative and not exclusive</li>
    </ul>
  </div>
  ...
  <div class="sl-section">
    ...
    <ul>
      <li><strong>Entire Agreement:</strong> This Agreement constitutes the entire agreement between the parties regarding confidentiality and supersedes all prior discussions and agreements</li>
      ...
      <li><strong>Assignment:</strong> The Company may assign this Agreement to any successor. The Employee may not assign their obligations</li>
      <li><strong>Governing Law:</strong> This Agreement shall be governed by the laws of the Republic of Sierra Leone</li>
      <li><strong>Jurisdiction:</strong> Any disputes shall be subject to the exclusive jurisdiction of the courts of Sierra Leone</li>
    </ul>
  </div>
...
<div class="sl-document">
  ...
  <div class="sl-section">
    <h2>5. PROTECTION FROM RETALIATION</h2>
    <p>{{company_name}} strictly prohibits retaliation against any employee who:</p>
    <ul>
      <li>Reports harassment or discrimination in good faith</li>
      <li>Participates in an investigation as a witness or provides information</li>
      <li>Opposes or speaks out against harassment</li>
      <li>Supports a colleague who has experienced harassment</li>
    </ul>
    <p>Retaliation includes any adverse action such as demotion, pay reduction, unfavorable assignments, exclusion from activities, or any form of intimidation or hostility. Anyone found to have engaged in retaliation will face disciplinary action up to and including termination.</p>
    <p>If you believe you are experiencing retaliation, report it immediately using the same channels as harassment complaints.</p>
  </div>

  <div class="sl-section">
    <h2>6. PREVENTION & TRAINING</h2>
    <p>{{company_name}} is committed to preventing harassment through:</p>
    <ul>
      <li>Regular anti-harassment training for all employees</li>
      <li>Mandatory training for managers and supervisors on recognizing and addressing harassment</li>
      <li>Clear communication of this policy to all new employees</li>
      <li>Creating a culture where respectful behavior is the norm</li>
      <li>Leadership modeling appropriate behavior</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>7. MANAGER RESPONSIBILITIES</h2>
    <p>Managers and supervisors have additional responsibilities:</p>
    <ul>
      <li>Model respectful and professional behavior at all times</li>
      <li>Take all complaints seriously and report them promptly to HR</li>
      <li>Never dismiss, minimize, or discourage harassment reports</li>
      <li>Monitor the work environment for inappropriate behavior</li>
      <li>Address concerning behavior before it escalates</li>
      <li>Support employees who report harassment</li>
    </ul>
    <p>Managers who fail to report known harassment or who retaliate against complainants will face disciplinary action.</p>
  </div>

  <div class="sl-section">
    <h2>8. CONSEQUENCES OF HARASSMENT</h2>
    <p>Employees found to have engaged in harassment, discrimination, or bullying may face disciplinary action, which will be proportionate to the severity and nature of the offense:</p>
    <ul>
      <li><strong>Minor offenses:</strong> Counseling, verbal warning, or written warning</li>
      <li><strong>Serious offenses:</strong> Suspension, demotion, or transfer</li>
      <li><strong>Severe offenses:</strong> Immediate termination of employment</li>
      <li><strong>Criminal conduct:</strong> Referral to law enforcement authorities</li>
    </ul>
    <p>All disciplinary actions will be taken in accordance with the Company's Disciplinary Policy and the Employment Act 2023 of Sierra Leone. Previous complaints and patterns of behavior will be considered.</p>
  </div>

  <div class="sl-section">
    <h2>9. SUPPORT RESOURCES</h2>
    <p>If you have experienced harassment, the following support is available:</p>
    <ul>
      <li>Human Resources department for guidance and support</li>
      <li>Employee Assistance Program (if available)</li>
      <li>External resources and counseling services</li>
      <li>Ministry of Labour for external complaints</li>
    </ul>
    <p>Remember: You are not alone, and you have the right to work in an environment free from harassment.</p>
  </div>
