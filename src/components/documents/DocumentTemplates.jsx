...
<div class="sl-document">
  ...
  <div class="sl-section">
    ...
    <div class="sl-highlight-box" style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-color: #059669;">
      ...
      <p>We are delighted to inform you that you have successfully completed your probationary period with {{company_name}}. This letter serves as <strong>official confirmation</strong> of your permanent employment status, effective <strong>{{confirmation_date}}</strong>.</p>
    </div>
  </div>
  ...
  <div class="sl-section">
    ...
    <div class="sl-info-grid">
      ...
      <div class="sl-info-item" style="border-left-color: #059669;">
        ...
        <span>{{probation_duration}} months</span>
      </div>
      <div class="sl-info-item" style="border-left-color: #059669;">
  ...
  <div class="sl-section">
    <h2>Probation Performance Review</h2>
    <p>During your probationary period of {{probation_duration}} months, we have carefully evaluated your performance, conduct, and integration into {{company_name}}. We are pleased to report the following:</p>
    
    <div class="sl-highlight-box" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-color: #22c55e;">
      <h3 style="color: #16a34a;">✅ Performance Assessment</h3>
      <ul>
        <li><strong>Technical Competence:</strong> You have demonstrated {{technical_competence}}</li>
        <li><strong>Work Quality:</strong> Your work consistently meets or exceeds expected standards</li>
        <li><strong>Productivity:</strong> You effectively manage your time and deliver results within deadlines</li>
        <li><strong>Professional Conduct:</strong> You maintain professional behavior and adhere to company policies</li>
        <li><strong>Team Integration:</strong> You have integrated well with colleagues and contribute positively to team dynamics</li>
        <li><strong>Attendance & Punctuality:</strong> Your attendance and timekeeping have been {{attendance_rating}}</li>
        <li><strong>Initiative & Learning:</strong> You show willingness to learn and take on new challenges</li>
      </ul>
    </div>

    <p><strong>Manager's Comments:</strong></p>
    <p>{{manager_comments}}</p>

    <p><strong>Areas for Continued Development:</strong></p>
    <p>{{development_areas}}</p>
  </div>

  <div class="sl-section">
    <h2>Employment Terms & Benefits</h2>
    <p>As a confirmed permanent employee, your employment is now governed by the full terms of your employment contract without probationary restrictions. You are entitled to all rights and benefits afforded to permanent staff:</p>
  </div>

  <div class="sl-section">
    <h2>Compensation Package</h2>
    <div class="sl-highlight-box">
      <h3>💰 Your Confirmed Remuneration</h3>
      <div class="sl-info-grid">
        <div class="sl-info-item">
        ...
        <div class="sl-info-item">
          <label>Salary Review</label>
          <span>{{salary_review_frequency}}</span>
        </div>
      </div>
    </div>
    <p><strong>Statutory Deductions:</strong> NASSIT (5% employee contribution), PAYE income tax (as applicable per NRA brackets)</p>
    <p><strong>Allowances:</strong> {{allowances}}</p>
  </div>

  <div class="sl-section">
    <h2>Leave Entitlements</h2>
    <p>Per the Employment Act 2023 of Sierra Leone, you are now entitled to:</p>
    <ul>
      <li><strong>Annual Leave:</strong> {{annual_leave_days}} working days per year (accrues from hire date, available for use now)</li>
      <li><strong>Sick Leave:</strong> 5 days paid sick leave per year with medical certificate</li>
      <li><strong>Maternity Leave:</strong> 14 weeks for female employees (6 weeks full pay, 8 weeks half pay)</li>
      <li><strong>Paternity Leave:</strong> 5 working days for male employees</li>
      <li><strong>Compassionate Leave:</strong> 5 days for immediate family bereavement</li>
      <li><strong>Public Holidays:</strong> All Sierra Leone public holidays with pay</li>
    </ul>
    <p>Refer to the Company Leave Policy for detailed information on applying for and taking leave.</p>
  </div>

  <div class="sl-section">
    <h2>Termination & Notice Period</h2>
    <p>Now that your probation is complete:</p>
    <ul>
      <li><strong>Notice Period:</strong> {{notice_period}} notice is required from either party to terminate employment (as per Section 85, Employment Act 2023)</li>
      <li><strong>Summary Dismissal:</strong> May still occur for gross misconduct as defined in Section 91 of the Act</li>
      <li><strong>Severance:</strong> Entitlement to statutory severance benefits upon qualifying termination circumstances</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>Additional Benefits & Policies</h2>
    <p>As a confirmed employee, you now have access to:</p>
    <ul>
      <li>{{additional_benefits}}</li>
    </ul>
    <p>Please familiarize yourself with all company policies available on the staff portal or from HR.</p>
  </div>

  <div class="sl-section">
    <h2>Continuing Obligations</h2>
    <p>Your confirmation is subject to your continued:</p>
    <ul>
      <li>Satisfactory performance of duties and responsibilities</li>
      <li>Compliance with all company policies, procedures, and Code of Conduct</li>
      <li>Adherence to confidentiality and data protection obligations</li>
      <li>Professional behavior and conduct</li>
      <li>Attendance and punctuality standards</li>
    </ul>
    <p>Your performance will continue to be reviewed {{review_frequency}} as part of our performance management system.</p>
  </div>

  <div class="sl-section">
    <h2>Message from Management</h2>
    <p>Dear {{employee_name}},</p>
    <p>Your successful completion of probation is a significant milestone, and we are pleased to have you as a valued permanent member of the {{company_name}} team. Your contributions during your initial months have been appreciated, and we have confidence in your ability to continue excelling in your role.</p>
    <p>We look forward to your continued growth, development, and success with us. Please do not hesitate to reach out to your supervisor or the HR department if you have any questions or need support.</p>
    <p><strong>Congratulations once again, and welcome to the permanent {{company_name}} family!</strong></p>
  </div>

  <div class="sl-acknowledgment">
    <h2>Employee Acceptance</h2>
    <p>I, <strong>{{employee_name}}</strong>, hereby acknowledge and accept:</p>
    <ul>
      ...
      <li>I am aware of my rights, benefits, and continuing obligations</li>
      <li>I agree to continue performing my duties to the best of my ability</li>
      <li>I will comply with all company policies and maintain professional standards</li>
    </ul>
  </div>
  ...
  <div class="sl-footer">
    ...
    <p><strong>{{company_name}}</strong></p>
    <p>Republic of Sierra Leone</p>
    <p class="sl-legal-note">This confirmation letter forms part of your permanent employment record. Retain a copy for your records.</p>
  </div>
</div>
    `,
    variables: [
      ...
      { key: "probation_duration", label: "Probation Duration (Months)", type: "select", options: ["3", "6"], default: "3" },
      { key: "confirmation_date", label: "Confirmation Date", type: "date", auto_fill: "today" },
      { key: "reports_to", label: "Reports To", type: "text", default: "Department Manager" },
      { key: "technical_competence", label: "Technical Competence Rating", type: "select", options: ["excellent technical skills and job knowledge", "good technical understanding with room for growth", "satisfactory competence in core job requirements"], default: "excellent technical skills and job knowledge" },
      { key: "attendance_rating", label: "Attendance Rating", type: "select", options: ["excellent", "very good", "satisfactory"], default: "excellent" },
      { key: "manager_comments", label: "Manager's Comments", type: "text", default: "{{employee_name}} has been a valuable addition to the team. Their dedication, positive attitude, and willingness to learn have been exemplary. We are confident they will continue to excel in their role." },
      { key: "development_areas", label: "Development Areas", type: "text", default: "Continue building expertise in [specific skill areas]. Opportunities for further professional development and training will be provided." },
      ...
      { key: "salary_review_frequency", label: "Salary Review Frequency", type: "select", options: ["Annually", "Bi-annually", "Based on performance"], default: "Annually" },
      { key: "allowances", label: "Allowances", type: "text", default: "As per employment contract and company policy" },
      { key: "annual_leave_days", label: "Annual Leave Days", type: "select", options: ["21", "25", "30"], default: "21" },
      { key: "notice_period", label: "Notice Period", type: "select", options: ["1 month", "2 months", "3 months"], default: "1 month" },
      { key: "additional_benefits", label: "Additional Benefits", type: "text", default: "Medical insurance scheme, professional development opportunities, employee welfare programs, performance bonus eligibility" },
      { key: "review_frequency", label: "Performance Review Frequency", type: "select", options: ["quarterly", "bi-annually", "annually"], default: "annually" },
      { key: "authorized_signatory", label: "Authorized Signatory", type: "text", default: "HR Manager" },
      { key: "signatory_title", label: "Signatory Title", type: "text", default: "Human Resources" },
      { key: "issue_date", label: "Issue Date", type: "date", auto_fill: "today" }
    ]
...
<div class="sl-document">
  ...
  <div class="sl-section">
    <p>Dear <strong>{{employee_name}}</strong>,</p>
    <p>This letter serves as <strong>official notice</strong> of the termination of your employment with <strong>{{company_name}}</strong>. This decision has been made in accordance with the provisions of your employment contract and the Employment Act 2023 of the Republic of Sierra Leone.</p>
  </div>

  <div class="sl-section">
    <h2>Termination Details</h2>
    <div class="sl-highlight-box" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-color: #64748b;">
      <div class="sl-info-grid">
        <div class="sl-info-item" style="border-left-color: #64748b;">
        ...
        <div class="sl-info-item" style="border-left-color: #64748b;">
          <label>Notice Issued Date</label>
  ...
  <div class="sl-section">
    ...
    <p><strong>{{termination_reason}}</strong></p>
    <p>{{termination_details}}</p>
    <p>This decision was made after careful consideration {{consultation_details}}.</p>
  </div>

  <div class="sl-section">
    <h2>Notice Period & Garden Leave</h2>
    <ul>
      <li><strong>Notice Period:</strong> {{notice_period}} as per your employment contract ({{contract_notice_section}})</li>
      <li><strong>Working During Notice:</strong> {{notice_work_requirement}}</li>
      <li><strong>Payment in Lieu:</strong> {{payment_in_lieu}}</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>Final Settlement & Entitlements</h2>
    <p>Your final settlement will include all statutory and contractual entitlements:</p>
    ...
    <div class="sl-highlight-box">
      ...
      <div class="sl-info-grid">
        <div class="sl-info-item">
          ...
          <span>Calculated to {{last_working_day}}</span>
        </div>
        <div class="sl-info-item">
          <label>Accrued Annual Leave</label>
          <span>{{accrued_leave_days}} days @ {{daily_rate}}/day</span>
        </div>
        <div class="sl-info-item">
          <label>Pro-rata Bonus (if applicable)</label>
          <span>{{prorata_bonus}}</span>
        </div>
        <div class="sl-info-item">
          <label>Settlement Timeline</label>
          <span>Within {{settlement_days}} working days</span>
        </div>
      </div>
    </div>
    ...
    <ul>
      <li>NASSIT contributions (5% employee, 10% employer) will be deducted and remitted as per law</li>
      <li>PAYE income tax will be deducted according to NRA regulations</li>
      <li>Any outstanding loans, advances, or deductions will be recovered from final pay</li>
    </ul>

    <p><strong>Additional Entitlements:</strong></p>
    <ul>
      <li>{{additional_entitlements}}</li>
    </ul>

    <p><strong>Severance Pay (if applicable):</strong></p>
    <p>{{severance_details}}</p>
  </div>

  <div class="sl-section">
    <h2>Return of Company Property</h2>
    <p>All company property must be returned in good condition on or before <strong>{{last_working_day}}</strong>. Failure to return items may result in deductions from your final pay or legal action. Items to be returned include:</p>
    <div class="sl-info-grid">
      <div class="sl-info-item">
        <label>Access Items</label>
        <span>ID card, access cards, keys, security passes</span>
      </div>
      <div class="sl-info-item">
        <label>IT Equipment</label>
        <span>Laptop, mobile phone, tablet, chargers, accessories</span>
      </div>
      <div class="sl-info-item">
        <label>Vehicles</label>
        <span>Company vehicle, fuel cards, vehicle keys</span>
      </div>
      <div class="sl-info-item">
        <label>Documents</label>
        <span>Files, records, manuals, proprietary information</span>
      </div>
    </div>
    <p><strong>Other Items:</strong> {{other_company_property}}</p>
  </div>

  <div class="sl-section">
    <h2>Data & Information Security</h2>
    <ul>
      <li>Delete all company data from personal devices and personal cloud storage</li>
      <li>Do not retain copies of company documents, files, customer lists, or proprietary information</li>
      <li>Your company email account will be deactivated on {{email_deactivation_date}}</li>
      <li>Access to company systems will be revoked on your last working day</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>Post-Employment Obligations</h2>
    <p>Please be reminded of your continuing obligations:</p>
    <ul>
      <li><strong>Confidentiality:</strong> Your Non-Disclosure Agreement remains in effect for {{nda_duration}} following termination. Do not disclose any confidential or proprietary information</li>
      <li><strong>Non-Solicitation:</strong> {{non_solicitation_clause}}</li>
      <li><strong>Non-Competition:</strong> {{non_compete_clause}}</li>
      <li><strong>Intellectual Property:</strong> All work product created during employment remains the property of {{company_name}}</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>Exit Formalities & Clearance</h2>
    <p>To complete your exit process:</p>
    <ol>
      <li><strong>Exit Interview:</strong> Schedule with HR at {{hr_contact}}</li>
      <li><strong>Clearance Form:</strong> Obtain sign-offs from your department, IT, Finance, and HR</li>
      <li><strong>Handover:</strong> Complete handover of responsibilities to {{handover_person}}</li>
      <li><strong>Final Payslip:</strong> Collect or will be emailed to {{employee_email}}</li>
      <li><strong>Service Certificate:</strong> Will be issued upon completion of clearance formalities</li>
      <li><strong>Reference Requests:</strong> Future references should be requested through HR</li>
    </ol>
  </div>

  <div class="sl-section">
    <h2>NASSIT & Tax Clearance</h2>
    <p>Upon completion of your employment:</p>
    <ul>
      <li>Your final NASSIT contributions will be submitted to NASSIT within the statutory deadline</li>
      <li>A NASSIT clearance form will be provided if requested</li>
      <li>Your total PAYE tax paid during employment will be reported to NRA</li>
      <li>A tax clearance certificate can be obtained from NRA for future employment</li>
    </ul>
  </div>

  <div class="sl-section">
    <h2>Your Rights</h2>
    <p>Under the Employment Act 2023 of Sierra Leone, you have the following rights:</p>
    <ul>
      <li><strong>Right to Written Reasons:</strong> You may request detailed written reasons for termination if not already provided</li>
      <li><strong>Right to Complaint:</strong> If you believe the termination is unfair, you may file a complaint with the Ministry of Labour and Social Security within {{complaint_period}} months</li>
      <li><strong>Right to Legal Representation:</strong> You may seek legal counsel to review this termination and advise on your rights</li>
      <li><strong>Right to Reference:</strong> You are entitled to request a factual reference from the company</li>
    </ul>
    <p>For information on filing unfair dismissal claims, contact:<br/>
    <strong>Ministry of Labour and Social Security</strong><br/>
    Freetown, Sierra Leone</p>
  </div>

  <div class="sl-section">
    <p>We acknowledge your service to {{company_name}} during your tenure and wish you success in your future endeavors. Should you have any questions regarding this termination or the exit process, please contact the Human Resources department.</p>
  </div>

  <div class="sl-signatures">
    <div class="sl-signature-block" style="max-width: 400px; margin: 0 auto;">
      <h4>For {{company_name}}</h4>
      <p><strong>{{authorized_signatory}}</strong></p>
      <p>{{signatory_title}}</p>
      <p>Date: {{issue_date}}</p>
  ...
  <div class="sl-section" style="margin-top: 40px; padding: 20px; background: #f9fafb; border-radius: 8px;">
    <h2 style="border: none; padding: 0; margin-bottom: 15px; background: none;">Acknowledgment of Receipt</h2>
    <p>I, <strong>{{employee_name}}</strong>, acknowledge that I have received this Notice of Termination of Employment on the date indicated below. I understand the contents of this letter including the termination date, final settlement details, and my obligations regarding return of company property and confidentiality.</p>
    <p style="font-size: 12px; color: #666; margin-top: 10px;"><em>Note: Your signature below acknowledges receipt of this document only and does not indicate agreement with or acceptance of the termination decision.</em></p>
    
    <div class="sl-info-grid" style="margin-top: 25px;">
      <div class="sl-info-item">
        <label>Employee Signature</label>
        <span style="border-bottom: 2px solid #cbd5e1; display: block; min-height: 50px; margin-top: 10px;"></span>
      </div>
      <div class="sl-info-item">
  ...
  <div class="sl-footer">
    ...
    <p><strong>{{company_name}}</strong></p>
    <p>Republic of Sierra Leone</p>
    <p class="sl-legal-note">This letter is strictly confidential and should be treated as such. It is provided in compliance with the Employment Act 2023. For HR inquiries: {{hr_contact}}</p>
  </div>
</div>
    `,
    ...
    variables: [
      ...
      { key: "position", label: "Position", type: "text", auto_fill: "employee.position" },
      { key: "department", label: "Department", type: "text", auto_fill: "employee.department" },
      { key: "hire_date", label: "Hire Date", type: "date", auto_fill: "employee.hire_date" },
      { key: "years_of_service", label: "Years of Service", type: "text", default: "To be calculated" },
      { key: "termination_type", label: "Termination Category", type: "select", options: ["Resignation (Employee Initiated)", "End of Fixed-Term Contract", "Redundancy (Business Reasons)", "Termination With Notice (Employer Initiated)", "Summary Dismissal (Gross Misconduct)", "Retirement", "Mutual Separation Agreement", "Abandonment of Employment", "Ill Health Termination"], default: "Termination With Notice (Employer Initiated)" },
      { key: "notice_date", label: "Notice Issued Date", type: "date", auto_fill: "today" },
      { key: "last_working_day", label: "Last Working Day", type: "date" },
      { key: "notice_period", label: "Notice Period", type: "select", options: ["Immediate (Summary Dismissal)", "7 days (Probation)", "1 month", "2 months", "3 months", "Payment in Lieu"], default: "1 month" },
      { key: "termination_reason", label: "Primary Reason", type: "select", options: ["Gross misconduct", "Poor performance", "Redundancy", "End of contract", "Resignation", "Retirement", "Other"], default: "As per discussions" },
      { key: "termination_details", label: "Detailed Explanation", type: "text", default: "As discussed in meetings with management and HR on [dates], this decision has been made based on [specific reasons]. All procedural requirements have been met in accordance with company policy and Sierra Leone law." },
      { key: "consultation_details", label: "Consultation Details", type: "text", default: "and consultation with your supervisor and the HR department" },
      { key: "contract_notice_section", label: "Contract Notice Clause", type: "text", default: "Clause 8 of your employment contract" },
      { key: "notice_work_requirement", label: "Notice Period Work Requirement", type: "select", options: ["You are required to work during the notice period", "You are excused from duties (garden leave) but remain employed", "Notice period waived - immediate termination"], default: "You are required to work during the notice period" },
      { key: "payment_in_lieu", label: "Payment in Lieu of Notice", type: "select", options: ["Not applicable - working notice period", "You will receive payment equivalent to [X] months salary in lieu of notice", "Partial payment in lieu for shortened notice"], default: "Not applicable - working notice period" },
      { key: "accrued_leave_days", label: "Accrued Leave Days", type: "number", default: 0 },
      { key: "daily_rate", label: "Daily Rate (SLE)", type: "text", default: "Based on monthly salary / 22 working days" },
      { key: "prorata_bonus", label: "Pro-rata Bonus", type: "text", default: "Not applicable" },
      { key: "settlement_days", label: "Settlement Processing (Days)", type: "select", options: ["7", "14", "21", "30"], default: "14" },
      { key: "additional_entitlements", label: "Additional Entitlements", type: "text", default: "13th month salary (if applicable), outstanding expense reimbursements, any other contractual benefits" },
      { key: "severance_details", label: "Severance Pay Details", type: "text", default: "Severance pay is not applicable for this type of termination. (Note: Severance is typically payable for redundancy or unfair dismissal under Sierra Leone law)" },
      { key: "other_company_property", label: "Other Company Property", type: "text", default: "Uniform, tools, protective equipment, parking pass, company credit card" },
      { key: "email_deactivation_date", label: "Email Deactivation Date", type: "date" },
      { key: "nda_duration", label: "NDA Duration Post-Employment", type: "select", options: ["indefinitely for trade secrets", "2 years", "3 years", "5 years"], default: "2 years" },
      { key: "non_solicitation_clause", label: "Non-Solicitation Details", type: "text", default: "For 12 months following termination, you agree not to solicit or attempt to solicit any customers, clients, or employees of the company." },
      { key: "non_compete_clause", label: "Non-Compete Details", type: "text", default: "For 6 months following termination, you agree not to engage in directly competitive business activities within Sierra Leone without prior written consent." },
      { key: "hr_contact", label: "HR Contact", type: "text", default: "Human Resources Department" },
      { key: "handover_person", label: "Handover To", type: "text", default: "Your supervisor or designated colleague" },
      { key: "complaint_period", label: "Complaint Filing Period (Months)", type: "select", options: ["3", "6", "12"], default: "6" },
      { key: "authorized_signatory", label: "Authorized Signatory", type: "text", default: "HR Manager" },
      { key: "signatory_title", label: "Signatory Title", type: "text", default: "Human Resources" },
      { key: "issue_date", label: "Issue Date", type: "date", auto_fill: "today" }
    ]
